...
begin
  sqlBankID_USER.AsInteger      := DBDados.varID_USER;
  sqlBankID_COMPANY.AsInteger   := Company.id_company;
end;
...
begin
    ...
    sqlBank.Close;
    sqlBank.Params.ParamByName('ID_COMPANY').AsInteger :=  Company.id_company;
    sqlBank.Open;
...
begin
  ...
  sqlBank.Close;
  sqlBank.Params.ParamByName('ID_COMPANY').AsInteger := -1;
  sqlBank.Open;

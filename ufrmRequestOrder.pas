...
type
  TfrmRequestOrder = class(TForm)
    ...
    sqlGrid3: TFDQuery;
    dsGrid3: TDataSource;
    sqlGrid3ID_REQUESTORDER: TFDAutoIncField;
    sqlGrid3REQ_DATE: TStringField;
    sqlGrid3ID_PROCESS: TIntegerField;
    sqlGrid3MANUFACTORY: TStringField;
    sqlGrid3STYLE: TStringField;
    sqlGrid3PRODUCT: TStringField;
    sqlGrid3SKU: TStringField;
    sqlGrid3COMPANYNAME: TStringField;
    sqlGrid3COMPANY_ADDRESS: TStringField;
    sqlGrid3COMPANY_ST: TStringField;
    sqlGrid3COMPANY_CITY: TStringField;
    sqlGrid3COMPANY_ZIPCODE: TStringField;
    sqlGrid3COMPANY_PHONENUMBER: TStringField;
    sqlGrid3COMPANY_COUNTY: TStringField;
    sqlGrid3NAME: TStringField;
    sqlGrid3ESTIMATEDCOST: TBCDField;
    sqlGrid3DATE_ORDERED: TSQLTimeStampField;
    sqlGrid3GROUPNUMBER: TIntegerField;
    sqlGrid3SELECTED: TStringField;
    sqlGrid3ID_SUPPLIER: TIntegerField;
    sqlGrid3ADDRESS1: TStringField;
    sqlGrid3ZIPCODE: TStringField;
    sqlGrid3CITY: TStringField;
    sqlGrid3COUNTY: TStringField;
    sqlGrid3STATEE: TStringField;
    sqlGrid3NAME_1: TStringField;
    sqlGrid3POSITION: TStringField;
    sqlGrid3EMAIL: TStringField;
    sqlGrid3PHONE1: TStringField;
    sqlGrid3PHONE2: TStringField;
    sqlGrid3SOURCE: TStringField;

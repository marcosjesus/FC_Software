object frmCustomerLP: TfrmCustomerLP
  Left = 0
  Top = 0
  Caption = 'Customer Legal Person'
  ClientHeight = 536
  ClientWidth = 981
  Color = clBtnFace
          ...
          object Panel2: TPanel
            ...
            object Panel4: TPanel
              ...
              object cxLookupComboBoxCompany: TcxLookupComboBox
                ...
                TabOrder = 0
                OnClick = cxLookupComboBoxCompanyClick
                Width = 300
              end
              object cxLookupComboBoxVendor: TcxLookupComboBox
                Left = 581
                Top = 8
  ...
  object sqlGrid: TFDQuery
    ...
    SQL.Strings = (
      ...
      'C.TYPEPERSON'
      'FROM TBCUSTOMER C'
      'INNER JOIN TBCOMPANY Y ON Y.ID_COMPANY = C.ID_COMPANY'
      'INNER JOIN TBUSER U ON U.ID_USER = C.ID_USER'
    ...
    object sqlGridID_CUSTOMER: TIntegerField
      FieldName = 'ID_CUSTOMER'
      Origin = 'ID_CUSTOMER'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object sqlGridLAST_NAME: TStringField
      FieldName = 'LAST_NAME'
      Origin = 'LAST_NAME'
      Size = 30
    end
    object sqlGridFIRST_NAME: TStringField
    ...
    object sqlGridLASTNAME: TStringField
      FieldName = 'LASTNAME'
      Origin = 'LASTNAME'
    end
    ...
    object sqlGridTYPEPERSON: TStringField
  ...
  object sqlVendor: TFDQuery
    ...
    SQL.Strings = (
      'SELECT C.*'
      'FROM TBCONTRACTORS C'
      'INNER JOIN TBPOSITION P ON P.ID_POSITION = C.ID_POSITION'
      'WHERE P.NAME IN ( '#39'MANAGER'#39','#39'SALES REPRESENTATIVE'#39')'
    ...
    object sqlVendorID_CONTRACTORS: TIntegerField
      FieldName = 'ID_CONTRACTORS'
      Origin = 'ID_CONTRACTORS'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object sqlVendorID_MAIN_USER: TIntegerField
      FieldName = 'ID_MAIN_USER'
      Origin = 'ID_MAIN_USER'
    end
    object sqlVendorNAME: TStringField
      FieldName = 'NAME'
      Origin = 'NAME'
      Size = 50
    end
    object sqlVendorID_POSITION: TIntegerField
      FieldName = 'ID_POSITION'
      Origin = 'ID_POSITION'
    end
    object sqlVendorPHONE: TStringField
      FieldName = 'PHONE'
      Origin = 'PHONE'
      Size = 12
    end
    object sqlVendorEMAIL: TStringField
      FieldName = 'EMAIL'
      Origin = 'EMAIL'
      Size = 100
    end
    object sqlVendorDRIVER_LICENSE: TStringField
      FieldName = 'DRIVER_LICENSE'
      Origin = 'DRIVER_LICENSE'
    end
    object sqlVendorID_USER: TIntegerField
      FieldName = 'ID_USER'
      Origin = 'ID_USER'
    end
    object sqlVendorCOMISSION: TBCDField
      FieldName = 'COMISSION'
      Origin = 'COMISSION'
      Precision = 15
      Size = 2
    end
    object sqlVendorADD_DATE: TDateField
      FieldName = 'ADD_DATE'
      Origin = 'ADD_DATE'
    end
    object sqlVendorUPD_DATE: TDateField
      FieldName = 'UPD_DATE'
      Origin = 'UPD_DATE'
    end
    object sqlVendorID_COMPANY: TIntegerField
      FieldName = 'ID_COMPANY'
      Origin = 'ID_COMPANY'
    end
  end
  ...
  object sqlContact: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select * from TBCONTACT where id_address = :id_address and id_cu' +
        'stomer = :id_customer')
    Left = 792
    Top = 274
    ParamData = <

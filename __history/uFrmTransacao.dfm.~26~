object frmTransacao: TfrmTransacao
  ...
  object cdsTransacao: TClientDataSet
    ...
    object cdsTransacaoALTERADO: TStringField
      FieldName = 'ALTERADO'
      FixedChar = True
      Size = 3
    end
    ...
    object cdsTransacaoID_BANKING: TIntegerField
      FieldName = 'ID_BANKING'
    end
    object cdsTransacaoFORECAST: TSmallintField
      FieldName = 'FORECAST'
    end
    object cdsTransacaoID_USERBANK: TIntegerField
      FieldName = 'ID_USERBANK'
    end
    object cdsTransacaoMODO: TStringField
      FieldName = 'MODO'
      FixedChar = True
      Size = 1
    end
    object cdsTransacaoID_COMPANY: TIntegerField
      FieldName = 'ID_COMPANY'
    end
    object cdsTransacaoCONCILIADO: TIntegerField
      FieldName = 'CONCILIADO'
    end
    object cdsTransacaoNUM_PARCELA: TStringField
      FieldName = 'NUM_PARCELA'
      Size = 10
    end
    object cdsTransacaoFOREIGN_KEY: TIntegerField
      FieldName = 'FOREIGN_KEY'
    end
    object cdsTransacaoINTERNALCOD: TStringField
  ...
  object sqlCentroCusto: TFDQuery
    Connection = DBDados.FDConnection
    SQL.Strings = (
      'WITH DADOS (ID_CENTRODECUSTO, INTERNALCOD)AS'
      '('

object frmLabor: TfrmLabor
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object chklistService: TCheckListBox
    Left = 0
    Top = 41
    Width = 752
    Height = 335
  ...
  object dsLabor: TDataSource
    DataSet = sqlLabor
    Left = 417
    Top = 98
  end
  object sqlLabor: TFDQuery
    Connection = DBDados.FDConnection
    SQL.Strings = (
      'SELECT * FROM TBLABOR')
    Left = 320
    Top = 112
    object sqlLaborID_LABOR: TFDAutoIncField
      FieldName = 'ID_LABOR'
      Origin = 'ID_LABOR'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object sqlLaborDESCRIPTION: TStringField

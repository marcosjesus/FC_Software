object frmAccessControl: TfrmAccessControl
  Left = 0
  Top = 0
  ...
  object sqlPositionMenu: TFDQuery
    Connection = DBDados.FDConnection
    SQL.Strings = (
      'SELECT * FROM TBPOSITION_ACCESS WHERE ID_POSITION = :ID_POSITION')
    Left = 352
    Top = 155
    ParamData = <
      item
    ...
    object sqlPositionMenuID_POSITION_ACCESS: TFDAutoIncField
      FieldName = 'ID_POSITION_ACCESS'
      Origin = 'ID_POSITION_ACCESS'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object sqlPositionMenuID_POSITION: TIntegerField
      FieldName = 'ID_POSITION'
      Origin = 'ID_POSITION'
    end
    object sqlPositionMenuID_MENU: TIntegerField
      FieldName = 'ID_MENU'
      Origin = 'ID_MENU'
    end
    object sqlPositionMenuADD_DATE: TSQLTimeStampField
      FieldName = 'ADD_DATE'
      Origin = 'ADD_DATE'
    end
  end
  object dsPositionMenu: TDataSource
    DataSet = sqlPositionMenu
    Left = 360
    Top = 211
  end

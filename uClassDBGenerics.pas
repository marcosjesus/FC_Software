...
begin
   ...
   begin
       if not ForceDirectories ( ExtractFilePath(Application.ExeName) +  varMainFolder ) then
        Exit;
   end;


   if not DirExists(  ExtractFilePath(Application.ExeName) +  varMainFolder + '\' + pasta  ) then
   begin
       if not ForceDirectories ( ExtractFilePath(Application.ExeName) +  varMainFolder + '\' + pasta ) then
        Exit;
   end;
end;
...
begin
   ...
   begin
       if not ForceDirectories ( ExtractFilePath(Application.ExeName) +  varMainFolder + '\' + subpasta  ) then
        Exit;
   end;
end;

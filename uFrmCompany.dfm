object frmCompany: TfrmCompany
    ...
    object cxTabSheetList: TcxTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGrid1DBTableView1: TcxGridDBTableView
          ...
          DataController.DataSource = dsCompany
          ...
          object cxGrid1DBTableView1TRADINGNAME: TcxGridDBColumn
            Caption = 'Trading Name'
            DataBinding.FieldName = 'TRADINGNAME'
            Width = 200
          end
          object cxGrid1DBTableView1COMPANYOWNER: TcxGridDBColumn
            Caption = 'Owner'
            DataBinding.FieldName = 'COMPANYOWNER'
            Width = 200
          end
          object cxGrid1DBTableView1PHONENUMBER: TcxGridDBColumn
            Caption = 'Phone #'
        ...
        object PgCPrincipal: TcxPageControl
          ...
          object TbSFicha: TcxTabSheet
            ...
            object Panel700: TPanel
              ...
              object edtCompanyPhone: TMaskEdit
                Left = 580
                Top = 5
                Width = 301
                Height = 22
          ...
          object cxTabSheet1: TcxTabSheet
            ...
            object cxGrid3: TcxGrid
              ...
              object cxGridDBTableView3: TcxGridDBTableView
                ...
                DataController.KeyFieldNames = 'ID_BANK'
                DataController.Summary.DefaultGroupSummaryItems = <>
                DataController.Summary.FooterSummaryItems = <>
                DataController.Summary.SummaryGroups = <>
                ...
                OptionsView.Indicator = True
                object cxGridDBTableView3ACCOUNTTYPE: TcxGridDBColumn
                  Caption = 'Type'
                ...
                object cxGridDBTableView3LASTNAME: TcxGridDBColumn
                  Caption = 'LastName'
                  DataBinding.FieldName = 'LASTNAME'
                  Width = 120
                end
                object cxGridDBTableView3MIDDLENAME: TcxGridDBColumn
                  Caption = 'MiddleName'
                  DataBinding.FieldName = 'MIDDLENAME'
                  Width = 120
                end
                object cxGridDBTableView3FIRSTNAME: TcxGridDBColumn
                  Caption = 'FirstName'
                  DataBinding.FieldName = 'FIRSTNAME'
                  Width = 120
                end
                object cxGridDBTableView3BANKNAME: TcxGridDBColumn
                  Caption = 'BankName'
                ...
                object cxGridDBTableView3ACCOUNT: TcxGridDBColumn
                  Caption = 'Account Number'
                  DataBinding.FieldName = 'ACCOUNT'
                  Width = 120
                end
                object cxGridDBTableView3BALANCE: TcxGridDBColumn
                  Caption = 'Balance U$'
  ...
  object sqlGrid: TFDQuery
    ...
    object sqlGridTAX_ID: TStringField
      FieldName = 'TAX_ID'
      Origin = 'TAX_ID'
    end
    ...
    object sqlGridTRADINGNAME: TStringField
      FieldName = 'TRADINGNAME'
      Origin = 'TRADINGNAME'
      Size = 50
    end
    object sqlGridCOMPANYOWNER: TStringField
    ...
    object sqlGridCOUNTRY: TStringField
      FieldName = 'COUNTRY'
      Origin = 'COUNTRY'
      Size = 30
    end
    object sqlGridST: TStringField
      FieldName = 'ST'
      Origin = 'ST'
      Size = 2
    end
    ...
    object sqlGridPHONENUMBER: TStringField
  ...
  object sqlImage: TFDQuery
    ...
    object sqlImageID_COMPANY: TIntegerField
      FieldName = 'ID_COMPANY'
      Origin = 'ID_COMPANY'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
  ...
  object sqlBank: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT ID_BANK, ID_COMPANY, ACCOUNTTYPE, LASTNAME, MIDDLENAME, F' +
        'IRSTNAME, BANKNAME, ROUTING, ACCOUNT, BALANCE, ADD_DATE, UPD_DAT' +
        'E, ID_USER'
      'FROM TBBANK'
    ...
    object sqlBankACCOUNTTYPE: TStringField
      FieldName = 'ACCOUNTTYPE'
      Origin = 'ACCOUNTTYPE'
    end
    object sqlBankLASTNAME: TStringField
      FieldName = 'LASTNAME'
      Origin = 'LASTNAME'
      Size = 50
    end
    object sqlBankMIDDLENAME: TStringField
      FieldName = 'MIDDLENAME'
      Origin = 'MIDDLENAME'
      Size = 50
    end
    object sqlBankFIRSTNAME: TStringField
      FieldName = 'FIRSTNAME'
      Origin = 'FIRSTNAME'
      Size = 50
    end
    object sqlBankBANKNAME: TStringField
      FieldName = 'BANKNAME'
      Origin = 'BANKNAME'
      Size = 80
    end
    object sqlBankROUTING: TStringField
      FieldName = 'ROUTING'
      Origin = 'ROUTING'
    end
    ...
    object sqlBankBALANCE: TBCDField
      FieldName = 'BALANCE'
      Origin = 'BALANCE'
      Precision = 15
      Size = 2
    end
    object sqlBankADD_DATE: TSQLTimeStampField
      FieldName = 'ADD_DATE'
      Origin = 'ADD_DATE'
    end
    object sqlBankUPD_DATE: TSQLTimeStampField
      FieldName = 'UPD_DATE'
      Origin = 'UPD_DATE'
    end
    object sqlBankID_USER: TIntegerField
      FieldName = 'ID_USER'
      Origin = 'ID_USER'
    end
  end

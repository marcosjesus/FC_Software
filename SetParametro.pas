...
const
  ...
  WIDTH_CODIGO50  : Integer = 50;
  WIDTH_CODIGO60  : Integer = 60;
...
begin
  ...
  begin
    ...
    CaixaTexto.bs_Fields.Add('I.ID_PRODUCT;ID;;' + inttostr(WIDTH_CODIGO35));                            //0
    CaixaTexto.bs_Fields.Add('TP.DESCRIPTION;TYPE;;' + inttostr(WIDTH_CODIGO60));                        //1
    CaixaTexto.bs_Fields.Add('TS.DESCRIPTION;PRODUCT STYLE;;' + inttostr(WIDTH_DOCUMENTO));              //2
    ...
    CaixaTexto.bs_Fields.Add('I.PRICE_FINAL;RATE;;' + inttostr(WIDTH_CODIGO60));                         //9
    ...
    CaixaTexto.bs_Fields.Add('P.totalAreaSquareFeet;INVENTORY;;' + inttostr(WIDTH_CODIGO));              //12
  ...
  begin
    ...
    CaixaTexto.bs_Fields.Add('c.CREDIT;#;;' + inttostr(WIDTH_DOCUMENTO));                   //18

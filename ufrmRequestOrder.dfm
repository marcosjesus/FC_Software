    ...
    object cxTabSheetGrid: TcxTabSheet
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGrid1DBTableView1: TcxGridDBTableView
          ...
          object cxGrid1DBTableView1ID_PROCESS: TcxGridDBColumn
  ...
  object sqlGrid: TFDQuery
    ...
    SQL.Strings = (
      ...
      'INNER JOIN TBCONTRACTORS C ON C.ID_CONTRACTORS = A.ID_CONTRACTOR'
        ...
        'INNER JOIN TBPROCESS_ITEM D ON  D.id_process = A.ID_PROCESS AND ' +
        'D.ID_PROCESS_ITEM = A.ID_PROCESS_ITEM AND A.TABLENAME = '#39'TBORDER' +
        '_ITEM'#39
      
        'INNER JOIN TBPROCESS K ON K.ID_PROCESS = D.ID_PROCESS AND K.TABL' +
        'ENAME = '#39'TBORDER'#39
  ...
  object sqlGrid2: TFDQuery
    ...
    SQL.Strings = (
      ...
      'INNER JOIN TBCONTRACTORS C ON C.ID_CONTRACTORS = A.ID_CONTRACTOR'
        ...
        'INNER JOIN TBPROCESS_ITEM D ON  D.id_process = A.ID_PROCESS AND ' +
        'D.ID_PROCESS_ITEM = A.ID_PROCESS_ITEM AND D.TABLENAME = '#39'TBORDER' +
        '_ITEM'#39
      'INNER JOIN TBSUPPLIER E ON E.ID_SUPPLIER = A.ID_SUPPLIER'
      'INNER JOIN TBPRODUCT F ON F.ID_PRODUCT = A.ID_PRODUCT'
      'LEFT OUTER JOIN TBADDRESS G ON G.ID_SUPPLIER = E.ID_SUPPLIER'
  ...
  object sqlGrid3: TFDQuery
    ...
    SQL.Strings = (
      ...
      'H.PHONE2,'
        ...
        'CASE WHEN A.TABLENAME = '#39'TBESTIMATE_ITEM'#39' THEN '#39'QUOTATION'#39' END A' +
        'S SOURCE'
      'FROM [DBO].[TBREQUESTORDER] A'
      'INNER JOIN TBCOMPANY B ON A.ID_COMPANY = B.ID_COMPANY'
      'INNER JOIN TBCONTRACTORS C ON C.ID_CONTRACTORS = A.ID_CONTRACTOR'
        ...
        'INNER JOIN TBPROCESS_ITEM D ON  D.id_process = A.ID_PROCESS AND ' +
        'D.ID_PROCESS_ITEM = A.ID_PROCESS_ITEM AND A.TABLENAME = '#39'TBESTIM' +
        'ATE_ITEM'#39
      'INNER JOIN TBSUPPLIER E ON E.ID_SUPPLIER = A.ID_SUPPLIER'
      'INNER JOIN TBPRODUCT F ON F.ID_PRODUCT = A.ID_PRODUCT'
      'LEFT OUTER JOIN TBADDRESS G ON G.ID_SUPPLIER = E.ID_SUPPLIER'
    ...
    Left = 612
    Top = 104
    object sqlGrid3ID_REQUESTORDER: TFDAutoIncField
      FieldName = 'ID_REQUESTORDER'
      Origin = 'ID_REQUESTORDER'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object sqlGrid3REQ_DATE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'REQ_DATE'
      Origin = 'REQ_DATE'
      ProviderFlags = []
    ...
    object sqlGrid3ID_PROCESS: TIntegerField
      FieldName = 'ID_PROCESS'
      Origin = 'ID_PROCESS'
    end
    object sqlGrid3MANUFACTORY: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'MANUFACTORY'
      Origin = 'NAMEBUSINESS'
      ProviderFlags = []
    ...
    object sqlGrid3STYLE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'STYLE'
      Origin = 'STYLE'
      ProviderFlags = []
    ...
    object sqlGrid3PRODUCT: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'PRODUCT'
      Origin = 'PRODUCT'
      ProviderFlags = []
    ...
    object sqlGrid3SKU: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'SKU'
      Origin = 'SKU'
      ProviderFlags = []
    ...
    object sqlGrid3COMPANYNAME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'COMPANYNAME'
      Origin = 'COMPANYNAME'
      ProviderFlags = []
    ...
    object sqlGrid3COMPANY_ADDRESS: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'COMPANY_ADDRESS'
      Origin = 'ADDRESS1'
      ProviderFlags = []
    ...
    object sqlGrid3COMPANY_ST: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'COMPANY_ST'
      Origin = 'ST'
      ProviderFlags = []
    ...
    object sqlGrid3COMPANY_CITY: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'COMPANY_CITY'
      Origin = 'CITY'
      ProviderFlags = []
    ...
    object sqlGrid3COMPANY_ZIPCODE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'COMPANY_ZIPCODE'
      Origin = 'ZIPCODE'
      ProviderFlags = []
    ...
    object sqlGrid3COMPANY_PHONENUMBER: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'COMPANY_PHONENUMBER'
      Origin = 'PHONENUMBER'
      ProviderFlags = []
    ...
    object sqlGrid3COMPANY_COUNTY: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'COMPANY_COUNTY'
      Origin = 'COUNTY'
      ProviderFlags = []
    ...
    object sqlGrid3NAME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'NAME'
      Origin = 'NAME'
      ProviderFlags = []
    ...
    object sqlGrid3ESTIMATEDCOST: TBCDField
      FieldName = 'ESTIMATEDCOST'
      Origin = 'ESTIMATEDCOST'
      Precision = 15
      Size = 2
    end
    object sqlGrid3DATE_ORDERED: TSQLTimeStampField
      FieldName = 'DATE_ORDERED'
      Origin = 'DATE_ORDERED'
    end
    object sqlGrid3GROUPNUMBER: TIntegerField
      FieldName = 'GROUPNUMBER'
      Origin = 'GROUPNUMBER'
    end
    object sqlGrid3SELECTED: TStringField
      FieldName = 'SELECTED'
      Origin = 'SELECTED'
      FixedChar = True
      Size = 1
    end
    object sqlGrid3ID_SUPPLIER: TIntegerField
      FieldName = 'ID_SUPPLIER'
      Origin = 'ID_SUPPLIER'
    end
    object sqlGrid3ADDRESS1: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ADDRESS1'
      Origin = 'ADDRESS1'
      ProviderFlags = []
    ...
    object sqlGrid3ZIPCODE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ZIPCODE'
      Origin = 'ZIPCODE'
      ProviderFlags = []
    ...
    object sqlGrid3CITY: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CITY'
      Origin = 'CITY'
      ProviderFlags = []
    ...
    object sqlGrid3COUNTY: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'COUNTY'
      Origin = 'COUNTY'
      ProviderFlags = []
    ...
    object sqlGrid3STATEE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'STATEE'
      Origin = 'STATEE'
      ProviderFlags = []
    ...
    object sqlGrid3NAME_1: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'NAME_1'
      Origin = 'NAME'
      ProviderFlags = []
    ...
    object sqlGrid3POSITION: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'POSITION'
      Origin = '[POSITION]'
      ProviderFlags = []
    ...
    object sqlGrid3EMAIL: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'EMAIL'
      Origin = 'EMAIL'
      ProviderFlags = []
    ...
    object sqlGrid3PHONE1: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'PHONE1'
      Origin = 'PHONE1'
      ProviderFlags = []
    ...
    object sqlGrid3PHONE2: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'PHONE2'
      Origin = 'PHONE2'
      ProviderFlags = []
    ...
    object sqlGrid3SOURCE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'SOURCE'
      Origin = 'SOURCE'
      ProviderFlags = []
    ...
    object sqlGrid3TOTALAREA: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'TOTALAREA'
      Origin = 'TOTALAREA'
      ProviderFlags = []
